...
1.  Select the object with the **Liquid Potion** Shader applied.

2.  In the Inspector, locate the `Liquid Amount` property.

3.  Use the slider or input field to adjust the amount of liquid in the container.

### Liquid Properties

-   `Base Color`: Defines the main color of the liquid.
...
-   `Fresnel Color`: Sets the color of the glass.
